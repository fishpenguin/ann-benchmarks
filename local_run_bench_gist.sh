...
# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-flat.8192
# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-flat.4096
# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-flat.2048
# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-flat.1024
# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-flat.512

# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-pq.8192
# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-pq.4096
# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-pq.2048
# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-pq.1024
# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-pq.512

# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-sq8.8192
# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-sq8.4096
# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-sq8.2048
# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-sq8.1024
# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-sq8.512

# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-sq8h.8192
# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-sq8h.4096
# python run.py --dataset sift-128-euclidean --batch --local --definitions algos.yaml.milvus-gpu-hybrid-ivf-sq8h.2048
