...
# python run.py --dataset sift-128-euclidean --batch --definitions algos.yaml.milvus-ivf-sq8h.2048
# python run.py --dataset sift-128-euclidean --batch --definitions algos.yaml.milvus-ivf-sq8h.1024
# python run.py --dataset sift-128-euclidean --batch --definitions algos.yaml.milvus-ivf-sq8h.512
