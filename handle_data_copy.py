...
def handle_sift_1b(out_fn, size='1000M', base_size=1000000000):
...
def handle_sift_1b_single(out_fn, size='1000M', base_size=1000000000):
    f = h5py.File(out_fn, 'w')
    f.attrs['distance'] = 'euclidean'
    f.attrs['point_type'] = 'float'
    ...
    with open(train_fn, 'rb') as ftrain:
        ...
        vector_nums = min(vector_nums, base_size)
        print("vector_nums: ", vector_nums)
...
def main():
    ...
    handle_sift_1b_single(sift_prefix + '/sift-100m-euclidean.hdf5', '100M', base_size=100000000)
